...
const { incrementTripPackageTotal } = require('../services/tripServices');
...
const assignPackage = async (req, res) => {
    ...
    const { packageId, truckNo, tripId, status } = req.body;
    ...
    const packageMapping = await incrementTripPackageTotal(tripId);
